...
urlpatterns = [
    ...
    #path("edit_team/<int:id>/<int:id_champ>/", views.edit_team, name='edit_team'),
    ...
    path('edit_person/<int:person_id>/', views.edit_person, name='edit_person'),        #Person
    path('view_person/<int:person_id>/', views.view_person, name='view_person'),        #Person
    path('delete_person/<int:person_id>/', views.delete_person, name='delete_person'),  #Person
    ...
    path('remove_team_from_championship/<int:championship_id>/<int:team_id>/', views.remove_team_from_championship, name='remove_team_from_championship'),
    path('delete_category/<int:category_id>/', views.delete_category, name='delete_category'),
    path('edit_category/<int:category_id>/', views.edit_category, name='edit_category'),
    path("edit_championship/<int:championship_id>", views.edit_championship,name='edit_championship'),
